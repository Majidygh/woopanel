...
TR = {
    ...
    'Layout width': 'عرض و چیدمان پنل',
    'Full-width (Screen wide - Recommended)': 'تمام‌عرض (گسترده در کل عرض نمایشگر — پیشنهادی)',
    'The panel expands across the full screen width and gives your dashboard maximum breathing room without being squeezed by narrow theme containers.': 'پنل در تمام پهنای نمایشگر گسترده می‌شود و فضای کافی برای نمایش بدون فشردگی فراهم می‌کند.',
    'Boxed (Constrained to theme container)': 'داخل کادر (محدود به کانتینر قالب)',
    'The panel remains confined inside your active WordPress theme content width.': 'پنل درون عرض استاندارد محتوای قالب سایت شما باقی می‌ماند.',
    'Default theme': 'تم پیش‌فرض پنل',
    'Follow system theme': 'هماهنگ با تم سیستم',
    'Default color mode before user selects their preference in the sidebar.': 'حالت رنگ اولیه پیش از انتخاب ترجیح توسط کاربر در سایدبار.',
    'Corner radius': 'انحنای گوشه‌ها',
    'Rounded (18px - Modern)': 'گرد مدرن (۱۸ پیکسل)',
    'Smooth (10px)': 'ملایم (۱۰ پیکسل)',
    'Sharp (4px)': 'تیز و صنعتی (۴ پیکسل)',
    'Dashboard stat cards': 'کارت‌های آماری پیشخوان',
    'Show orders count': 'نمایش تعداد سفارش‌ها',
    'Show total spent': 'نمایش مجموع خرید',
    'Show average order': 'نمایش میانگین سفارش',
    'Show downloads count': 'نمایش تعداد فایل‌های دانلودی',
    'Order items thumbnails': 'پیش‌نمایش کالاهای سفارش',
    'Show product images in orders list and invoice': 'نمایش تصویر بندانگشتی محصولات در جدول سفارشات و فاکتور',
    'Tracking URL template': 'الگوی آدرس رهگیری مرسوله',
    'Use %s where the tracking barcode should be inserted. Defaults to Iran Post (https://tracking.post.ir/?id=%s).': 'از %s در جایی که کد رهگیری قرار می‌گیرد استفاده کنید. پیش‌فرض: سامانه رهگیری پست (https://tracking.post.ir/?id=%s).',
